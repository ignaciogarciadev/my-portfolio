...
export default function Projects() {
  return (
    ...
    >
        <div
          className="border-t border-gray-200  w-full h-full flex justify-between items-center"
        >
          <div className="2xl:max-w-[1400px]  2xl:px-[0] xl:max-w-[1180px] lg:max-w-[924px] md:max-w-[668px] sm:max-w-[640px] max-w-[560px] md:p-[0px] sm:px-[40px] px-[30px] m-auto w-full h-full flex flex-col md:flex-row justify-between items-center">
            <div className="text-left h-full w-full md:w-1/2 flex flex-col items-center justify-center gap-6">
              <div>
                <h2 className="lg:text-7xl md:text-6xl sm:text-7xl text-5xl font-semibold">Panadería La Miguería</h2>
                <p className="md:text-xl text-md">Página web y página de pedidos</p>
              </div>
        ...
        <div
          className=" border-b border-t border-gray-200  w-full h-full flex justify-between items-center"
        >
          <div className="2xl:max-w-[1400px]  2xl:px-[0] xl:max-w-[1180px] lg:max-w-[924px] md:max-w-[668px] sm:max-w-[640px] max-w-[560px] md:p-[0px] sm:px-[40px] px-[30px] m-auto w-full h-full flex flex-col md:flex-row justify-between items-center">
            <div className="text-left h-full w-full md:w-1/2 flex flex-col items-center justify-center gap-6">
              <div>
